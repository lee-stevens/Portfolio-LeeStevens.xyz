        ...
        <section>
          ...
          <nav class="siteLinks">
            <ul>
              <li>
                <p>LinkedIn</p>
                <a href="https://www.linkedin.com/in/lee-stevens-dev/">
                  <img src="images/icon - linkedin.png"></img>
                </a>
              </li>
              <li>
                <p>GitHub</p>
                <a href="https://github.com/leesprojects">
                  <img src="images/icon - github.png"></img> 
                </a>
              </li>
              <li>
                <p>Leetcode</p>
                <a href="https://leetcode.com/Zaeroso/">
                  <img src="images/icon - leetcode.png"></img>
                </a>
              </li>
            </ul>
          </nav>
